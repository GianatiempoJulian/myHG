     ...
     <div class="row">
         ...
         <div class = "row collection">
               ...
               foreach($figure_list as $figure){
                    foreach($us_x_fig_list as $us_x_fig){
                         if($us_x_fig->getFigureID() == $figure->getFigure_id()){
               ...
               <div class="col-5 col-xs-4 col-sm-4 col-md-2 col-lg-1" >
                         <div class = "figure-collection-id">
                              <div class="card card-figures <?php echo $figure->getCollection_id() ?>" >
                                   ...
                                   <a name ="figure_select" id="save-buttom" href="<?php echo FRONT_ROOT?>Figure/DeleteFigure/<?php echo $figure->getFigure_id()?>">Eliminar</a>    
                              </div>
                         </div>
